      ...
      >
        ...
        <main>
          <section className="content-left">
            <img
              src={logo}
              alt="Logo UPT Puskesmas Pamulang"
              className="logo"
            />
            ...
            <p className="description-text">
              ...
              Puskesmas Pamulang di situs ini yang disusun oleh Tim Farmasi
              Apotek UPT Puskesmas Pamulang. Layanan ini bertujuan untuk
              meningkatkan pengetahuan masyarakat dan tenaga kesehatan dalam
